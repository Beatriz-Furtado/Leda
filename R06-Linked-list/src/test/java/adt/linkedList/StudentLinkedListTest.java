...
public class StudentLinkedListTest {
	...
	public void testToArray() {
		...
		Assert.assertArrayEquals(new Integer[] { 2, 2, 1 }, lista1.toArray());
	}
	...
	public void testRemoveDuplicates() {
		...
		SingleLinkedListNode<Integer> node = new SingleLinkedListNode<Integer>(lista1.getHead().getData(), lista1.getHead().getNext());
		System.out.println(lista1.getHead().getData());
		lista1.removeDuplicates(node);
